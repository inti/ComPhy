...
psutils.add_taxid_from_h5file(table = table,file = 'gi_taxid.h5')
...
lcas = ttutils.get_lca_for_list(list(set(table['taxid'])),tax_nodes,tax_names,ref_species_id=ref_species)
